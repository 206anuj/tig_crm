...
class FteSerivce(models.Model):
    ...
    fte_serivce_service_type = models.CharField(max_length=255, choices=FTE_SERVICE_TYPE)
    fte_serivce_sourced_by = models.CharField(max_length=255, choices=FTE_SERVICE_SOURCED_BY)
    fte_serivce_subtype_type = models.CharField(max_length=255, choices=FTE_SERVICE_SUBTYPE)
    ...
    fte_serivce_customer_standby_fees = models.FloatField()
    fte_serivce_customer_day_rate = models.FloatField()
    fte_serivce_customer_additional_hrs_rate_oh = models.FloatField()
    fte_serivce_customer_monthly_rate = models.FloatField()
    fte_serivce_customer_additional_hrs_rate_ooh = models.FloatField()
    fte_serivce_customer_weekend_hourly = models.FloatField()
    fte_serivce_customer_half_day = models.FloatField()
    fte_serivce_customer_weekend_half_day = models.FloatField()
    fte_serivce_customer_ot_rate = models.FloatField()
    fte_serivce_customer_weekend_full_day = models.FloatField()
    fte_serivce_customer_ph_hourly = models.FloatField()
    fte_serivce_customer_tm_rate_hrs = models.FloatField()
    fte_serivce_customer_ph_half_day = models.FloatField()
    fte_serivce_customer_ph_full_day = models.FloatField()
 
    # Customer Pricing Details  (PO Currency)
    fte_serivce_customer_quote_po_conversion_rate = models.CharField(max_length=255)
    
    # Vendor Details
    fte_serivce_vendor_name = models.CharField(max_length=255) #this will come from VendorAccount
    fte_serivce_vendor_project = models.CharField(max_length=255) #this will come from VendorProject
    fte_serivce_purchase_order = models.CharField(max_length=255) #this will come from VendorPurchaseOrder
    fte_serivce_vendor_currency = models.CharField(max_length=255, choices=FTE_SERVICE_VENDOR_CURRENCY)
 
    # Vendor Pricing Details
    fte_serivce_vendor_standby_fees = models.FloatField()
    fte_serivce_vendor_day_rate = models.FloatField()
    fte_serivce_vendor_additional_hrs_rate_oh = models.FloatField()
    fte_serivce_vendor_monthly_rate = models.FloatField()
    fte_serivce_vendor_additional_hrs_rate_ooh = models.FloatField()
    fte_serivce_vendor_weekend_hourly = models.FloatField()
    fte_serivce_vendor_half_day = models.FloatField()
    fte_serivce_vendor_weekend_half_day = models.FloatField()
    fte_serivce_vendor_ot_rate = models.FloatField()
    fte_serivce_vendor_weekend_full_day = models.FloatField()
    fte_serivce_vendor_ph_hourly = models.FloatField()
    fte_serivce_vendor_tm_rate_hrs = models.FloatField()
    fte_serivce_vendor_ph_half_day = models.FloatField()
    fte_serivce_vendor_ph_full_day = models.FloatField()
